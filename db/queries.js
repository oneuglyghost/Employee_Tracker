...
const updateEmployeeRole = async (employeeId, roleId) => {
    const [result] = await connection.execute('UPDATE employee SET role_id = ? WHERE id = ?', [roleId, employeeId]);
